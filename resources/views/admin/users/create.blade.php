...
@section('content')
    ...
    {!! Form::open(['route' => ['users.store'], 'id' => 'userform', 'name' => 'userform']) !!}
    <div class="row">
        <!-- left column -->
        <div class="col-md-12">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                {!! Form::select('role', $model->roles, null, ['placeholder' => 'Select Role', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                {!! Form::select('salutation', $salutation_array, null, [

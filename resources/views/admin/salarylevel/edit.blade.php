...
{!! Form::open(array('route' => array('salarylevels.update',$model->id),'id'=>'salary_form','name'=>'salary_form','method' =>'PUT')) !!}
<div class="row">
            <!-- left column -->
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                  ...
                  <div class="box-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                      {!! Form::text('salary_start',$model->salary_from,['class'=>"form-control"]) !!}
                      </div>
                    </div>
                  </div>
                 <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                      {!! Form::text('salary_end',$model->salary_to,['class'=>"form-control"]) !!}
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                      {!! Form::text('eligibility',$model->eligibility,['class'=>"form-control",'onkeyup'=>"calculate_interest()"]) !!}
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                      {!! Form::text('interest',$model->interest,['class'=>"form-control",'onkeyup'=>"calculate_interest()"]) !!}
                      {!! Form::hidden('interest_amount',$model->interest_amount,['class'=>"form-control",'readonly'=>'']) !!}
                      {!! Form::hidden('total_to_be_repaid',$model->total_to_be_repaid,['class'=>"form-control",'readonly'=>'']) !!}
                      </div>
                    </div>
                  </div>
                  <!-- <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                      {!! Form::select('status',$status, $model->status, ['placeholder' => 'Select Status','class' => 'form-control'])!!}
                      </div>
                    </div>
                  </div>

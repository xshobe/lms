...
{!! Form::open(array('url'=>'admin/import/savings','id'=>'upload-form','autocomplete'=>'off','files'=>true)) !!}
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="{!! url('download/sample-savings-import-file') !!}"><button type="button" class="btn btn-sm btn-primary">Sample File</button></a>
                </div>
            </div>
            <div class="box-body">
...
$(document).ready(function(){
    ...
    $("#upload-form").validate({
        ...
        submitHandler: function() {
            ...
            $('#confirm-approve .content_msg').html('You are about to upload a savings payment list. <br>Before upload please verify entire list.<br><b>Important:</b> This action can\'t be undone.');

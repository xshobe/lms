        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                            ...
                            @if (count($total_loans) > 0)
                                ...
                                @foreach ($total_loans as $val)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-xs-1"><a title="View Loan Detail"
                                                    href="{!! url("admin/customers/$val->customer_id#$val->loan_id") !!}"><i class="fa fa-external-link"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="pagination-container">{{ $total_loans->links() }}</div>
                </div><!-- /.box-body -->
            </div><!-- /.box -->
        </div><!-- /.col -->
    </div><!-- /.row -->

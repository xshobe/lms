...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        @php
            ...
            $wrapper_class = $current_route == 'admin/home' ? 'home-wrapper' : '';
        @endphp
        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper {!! $wrapper_class !!}">

            <?php if ($current_route != 'admin/home' && $current_route != 'admin/dashboard'):?>
